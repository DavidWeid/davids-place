...
**Example:**
```html
<div class="flex flex-col tablet:flex-row gap-4 p-6 bg-white dark:bg-medium rounded-lg">
...
<h1 class="text-xl tablet:text-2xl desktop:text-4xl">
```
...
<!-- Complex example -->
<article class="bg-white dark:bg-medium text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-600">
```
...
<div class={`base-styles ${variant === 'large' ? 'large-variant' : ''} ${className}`}>
  <slot />
</div>
