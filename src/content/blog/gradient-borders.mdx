...
<div class="flex flex-wrap">
  <div class="relative w-max">
    ...
    <div class="absolute top-1/2 left-1/2 -translate-1/2">
      <div class="border-gradient-transparent before:rounded-xl flex h-12 w-[150px] items-center justify-center">
        Transparent
      </div>
    </div>
  ...
  <div class="relative w-max">
    ...
    <div class="absolute top-1/2 left-1/2 -translate-1/2">
      <div class="border-gradient-transparent before:rounded-xl flex h-12 w-[150px] items-center justify-center backdrop-blur-sm">
        Blurred
      </div>
    </div>
